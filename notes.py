...
class NotepadApp(QMainWindow):
    ...
    def highlight_text(self):
        ...
        if selected_text:
            ...
            if detected_language in self.language_colors:
                format.setForeground(self.language_colors[detected_language])

            cursor.insertHtml('<pre style="background-color: white;">' + highlighted_code + '</pre>')
            ...
            if detected_language == 'python':
                ...
                format.setForeground(Qt.darkYellow)
            elif detected_language == 'scala':
                format.setForeground(Qt.darkCyan)
            elif detected_language == 'haskell':
                format.setForeground(Qt.darkGray)
            elif detected_language == 'r':
                format.setForeground(Qt.darkBlue)
            elif detected_language == 'dart':
                format.setForeground(Qt.darkRed)
            elif detected_language == 'typescript':
                format.setForeground(Qt.darkGreen)
            elif detected_language == 'elixir':
                format.setForeground(Qt.darkMagenta)
            elif detected_language == 'clojure':
                format.setForeground(Qt.darkYellow)
            elif detected_language == 'julia':
                format.setForeground(Qt.darkCyan)
            elif detected_language == 'perl':
                format.setForeground(Qt.darkGray)
            elif detected_language == 'lua':
                format.setForeground(Qt.darkBlue)
            elif detected_language == 'crystal':
                format.setForeground(Qt.darkRed)
            elif detected_language == 'ocaml':
                format.setForeground(Qt.darkGreen)
            elif detected_language == 'erlang':
                format.setForeground(Qt.darkMagenta)
            elif detected_language == 'bash':
                format.setForeground(Qt.darkYellow)
            elif detected_language == 'powershell':
                format.setForeground(Qt.darkCyan)
            elif detected_language == 'plaintext':
                format.setForeground(Qt.darkGray)
